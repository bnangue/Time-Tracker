...
public class ChatPeople {
    ...
    private String PERSON_NAME = "person_name";//username receiver
    private String PERSON_EMAIL = "person_email";
    private String PERSON_DEVICE_ID = "person_device_id";//regId receiver
    private String PERSON_CHAT_MESSAGE = "person_chat_message";// message
    private String PERSON_CHAT_TO_FROM = "status"; // to_from 1 if recieved 0 if sent
